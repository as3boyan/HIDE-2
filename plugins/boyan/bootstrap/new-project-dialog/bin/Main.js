	...
	if(NewProjectDialog.projectLocation.value != "" && NewProjectDialog.projectName.value != "") js.Node.require("fs").exists(NewProjectDialog.projectLocation.value,function(exists) {
		if(exists) {
			...
			if(item.createProjectFunction != null) {
				var projectPackage;
				var data = "";
				if(NewProjectDialog.checkboxes.get("Package").checked) data = NewProjectDialog.textfieldsWithCheckboxes.get("Package").value;
				projectPackage = data;
				var projectCompany;
				var data = "";
				if(NewProjectDialog.checkboxes.get("Company").checked) data = NewProjectDialog.textfieldsWithCheckboxes.get("Company").value;
				projectCompany = data;
				var projectLicense;
				var data = "";
				if(NewProjectDialog.checkboxes.get("License").checked) data = NewProjectDialog.textfieldsWithCheckboxes.get("License").value;
				projectLicense = data;
				var projectURL;
				var data = "";
				if(NewProjectDialog.checkboxes.get("URL").checked) data = NewProjectDialog.textfieldsWithCheckboxes.get("URL").value;
				projectURL = data;
