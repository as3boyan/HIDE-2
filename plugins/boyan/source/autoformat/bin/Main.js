...
var HaxePrinter = function() { };
HaxePrinter.__name__ = true;
HaxePrinter.formatSource = function(source) {
...
Main.main = function() {
	HIDE.waitForDependentPluginsToBeLoaded(Main.$name,Main.dependencies,function() {
		BootstrapMenu.getMenu("Source",3).addMenuItem("Autoformat",1,function() {
			if(js.Node.require("path").extname(TabManager.getCurrentDocumentPath()) == ".hx") {
				var data = TabManager.editor.getValue();
				if(data != "") {
...
Main.$name = "boyan.source.autoformat";
Main.dependencies = ["boyan.bootstrap.menu","boyan.bootstrap.tab-manager"];
